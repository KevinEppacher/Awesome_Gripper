...
def generate_launch_description():
    ...
    gripper_description_pkg = get_package_share_directory("application_description")

    # Path to the robot's Xacro file
    path_to_urdf = os.path.join(gripper_description_pkg, "urdf", "application_description.urdf.xacro")
