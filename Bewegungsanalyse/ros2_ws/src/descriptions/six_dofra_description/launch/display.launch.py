...
def generate_launch_description():
    ...
    six_dofra_description_pkg = get_package_share_directory("six_dofra_description")

    # Path to the robot's Xacro file
    path_to_urdf = os.path.join(six_dofra_description_pkg, "urdf", "six_dofra_description.urdf.xacro")
    ...
    # Joint State Publisher GUI - allows manual adjustment of joint angles
    ...
    rviz = Node(
        ...
        name="rviz2",
        output="screen",
        arguments=["-d", os.path.join(six_dofra_description_pkg, "rviz", "six_dofra_description.rviz")],
    )
